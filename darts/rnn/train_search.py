...
import data
import model_search as model_s
...
class Train():
    ...
    def main(self,epoch,arch):
        ...
        if args.continue_train:
            ...
            model = model_s.RNNModelSearch(ntokens, args.emsize, args.nhid, args.nhidlast,
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            train(train_data,model,parallel_model,optimizer,search_data,architect)

            val_loss = evaluate(val_data, model,parallel_model,eval_batch_size)
            logging.info('-' * 89)
...
def evaluate(data_source, model,parallel_model,batch_size=10):
...
def train(train_data,model,parallel_model,optimizer,search_data,architect):
